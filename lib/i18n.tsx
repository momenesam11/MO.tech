...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'numbers.rate':     { en: 'Satisfaction Rate',  ar: 'ارضاء العميل' },
  ...
  'projects.seeMore':  { en: 'See More', ar: 'عرض المزيد' },
  ...
  'about.exp.years': { en: 'Years', ar: 'سنوات' },
  'about.exp.experience': { en: 'Experience', ar: 'خبرة' },
  'about.step1.title': { en: 'Education', ar: 'التعليم' },
  'about.step1.desc': { en: 'BSc in Computer Science — Ain Shams University', ar: 'بكالوريوس علوم حاسب — جامعة عين شمس' },
  'about.step1.detail': { en: 'Grade: Very Good · 2023', ar: 'تقدير: جيد جدًا · 2023' },
  'about.step2.title': { en: 'Frontend Development Diploma', ar: 'دبلومة تطوير الواجهات الأمامية' },
  'about.step2.desc': { en: 'Route IT Training Center', ar: 'Route IT Training Center' },
  'about.step2.detail': { en: 'Certified 6-month program · Feb 2026', ar: 'برنامج معتمد 6 أشهر · فبراير 2026' },
  'about.step3.title': { en: 'Top Rated Seller', ar: 'أعلى رتبة بائع' },
  'about.step3.desc': { en: 'Achieved the highest seller rank on Khamsat freelance platform', ar: 'حاصل على أعلى رتبة في موقع خمسات للعمل الحر' },
  'about.step3.detail': { en: 'Khamsat Platform', ar: 'منصة خمسات' },
  'about.step4.title': { en: 'Professional Experience', ar: 'الخبرة المهنية' },
  'about.step4.desc': { en: '4+ years of professional UI/UX design experience', ar: '+4 سنوات خبرة احترافية في تصميم UI/UX' },
  'about.step4.detail': { en: 'Pixel-perfect implementation & design-to-code translation', ar: 'تنفيذ دقيق وترجمة التصميم إلى كود' },
  'about.step5.title': { en: 'Experience Certificate', ar: 'شهادة خبرة' },
  'about.step5.desc': { en: 'From Route for web & systems development', ar: 'من Route لتطوير المواقع والأنظمة' },
  'about.step5.detail': { en: 'Web Development & Systems', ar: 'تطوير المواقع والأنظمة' },
  ...
  'contact.ph.name':  { en: 'e.g. Ahmed Mohamed',         ar: 'اكتب اسمك الكامل' },
  'contact.ph.email': { en: 'e.g. name@example.com',    ar: 'اكتب بريدك الإلكتروني' },
  'contact.ph.sub':   { en: 'e.g. Website Design Project',    ar: 'اكتب موضوع رسالتك' },
  'contact.ph.msg':   { en: 'Tell me about your project idea and goals...', ar: 'اكتب تفاصيل مشروعك واللي محتاجه...' },
